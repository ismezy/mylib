 ...
 * enforcer 管理基础实现
 */
class SimpleEnforcerManager : EnforcerManager<LoginUser> {
  /**
   * 用户权限服务
   */
  var userAuthzService: UserAuthzService<LoginUser>? = null

  override fun getEnforcer(user: LoginUser): Enforcer {
